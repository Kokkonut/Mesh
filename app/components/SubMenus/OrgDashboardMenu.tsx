...
const OrgDashboardMenu = ({ sidebarOpen, setSideBarOpen }: SidebarProps) => {
    ...
    return (
        <>
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <React.Fragment>
                            ...
                            >
                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                    <li>
                                        <NavLink
                                            to={`../organization-dashboard/${orgId}/users/invite`}
                                            className={({ isActive }) =>
                                    ...
                                    <li>
                                        <NavLink
                                            to={`../organization-dashboard/${orgId}/users/manage`}
                                            className={({ isActive }) =>
                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                                (isActive && "!text-white")
                                            }
                ...
                {/* Projects group */}
                <SidebarLinkGroup
                    activeCondition={pathname.includes("projects")}
                >
                    {(handleClick, open) => (
                        <React.Fragment>
                            <NavLink
                            ...
                            >
                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                    <li>
                                        <NavLink
                                            to={`../organization-dashboard/${orgId}/projects/create`}
                                            className={({ isActive }) =>
                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                                (isActive && "!text-white")
                                            }
                                    ...
                                    <li>
                                        <NavLink
                                            to={`../organization-dashboard/${orgId}/projects/manage`}
                                            className={({ isActive }) =>
                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                                (isActive && "!text-white")
                                            }
...
export default OrgDashboardMenu;
